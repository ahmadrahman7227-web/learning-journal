...
- :visited -> menargetkan link yang sudah pernah dikunjungi.- :local-link -> menargetkan link internal yang menuju halaman yang sama.
...
- :last-child -> anak terakhir dari sebuah parent.
...
- :last-of-type -> elemen terakhir dari jenis tertentu dalam parent.
...
- ::first-letter -> menargetkan huruf pertama dari isi elemen.- ::marker -> menargetkan tanda bullet atau nomor pada list.

## Kesimpulan:

Pseudo-class digunakan untuk memilih elemen berdasarkan keadaan atau posisi dalam dokumen,
sedangkan pseudo-element digunakan untuk menargetkan bagian tertentu dari isi elemen, biasanya
untuk dekorasi atau styling khusus